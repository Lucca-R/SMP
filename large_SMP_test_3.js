...
firstBlockInst : '<div><p style="font-size:18px; text-align:left; margin-left:10px; font-family:arial"><color="000000"><br/><br/><br/>' + 
"See how fast it is? Don't worry if you miss some. Go with your gut feelings.<br/><br/>" + 
'Concentrate on each Chinese symbol and rate whether it means something Violent (use <b>leftKey</b>) or something Peaceful (use <b>rightKey</b>).<br/><br/>' + 
'Evaluate only the Chinese symbol, not the image that appears before it. Those images are sometimes distracting.<br/><br/>' + 
'<p style="font-size:16px; text-align:center; font-family:arial"><color="000000"><br/><br/>' + 
'Ready? Hit the <b>space bar</b>.</p>' + 
'<p style="font-size:12px; text-align:center; font-family:arial">' + 
'<color="000000">[Round 2 of nBlocks]</p></div>',
